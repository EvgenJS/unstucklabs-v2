...
const DISMISS_KEY = "unstuck-daily:push-banner-dismissed";
  ...
  return (
    <div className="mx-auto mt-4 flex max-w-lg items-center justify-between gap-3 rounded-lg border border-border bg-white px-4 py-3 text-sm">
      <p className="text-foreground/70">
        Want a gentle nudge if you drift off mid-task? We'll only ping you about the task you started, no more than
        once a day.
      </p>
