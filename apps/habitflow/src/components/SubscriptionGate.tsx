...
// apps/unstuck-daily/src/components/SubscriptionGate.tsx, extended with a
// `trial-available` state for the 5-day free trial.
export function SubscriptionGate({ children }: { children: ReactNode }) {
  ...
  if (access === "no-subscription") {
    return (
      <GateScreen
        title="HabitFlow needs an active subscription"
        body="Your free trial has ended. Subscribe on the store to keep building your habits, then come back here."
